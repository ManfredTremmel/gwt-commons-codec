...
public class Languages {
    ...
    static {
       final Set<String> ashkenaziLangs = new HashSet<String>(Arrays.asList("any",
            "cyrillic", "english", "french", "german", "hebrew", "hungarian", "polish",
            "romanian", "russian", "spanish"));
       LANGUAGES.put(NameType.ASHKENAZI, new Languages(ashkenaziLangs));
       final Set<String> genericLangs = new HashSet<String>(Arrays.asList("any",
            "arabic", "cyrillic", "czech", "dutch", "english", "french", "german", "greek",
            "greeklatin", "hebrew", "hungarian", "italian", "polish", "portuguese", "romanian",
            "russian", "spanish", "turkish"));
       LANGUAGES.put(NameType.GENERIC, new Languages(genericLangs));
       final Set<String> sephardicLangs = new HashSet<String>(Arrays.asList("any",
            "french", "hebrew", "italian", "portuguese", "spanish"));
       LANGUAGES.put(NameType.SEPHARDIC, new Languages(sephardicLangs));
    }
