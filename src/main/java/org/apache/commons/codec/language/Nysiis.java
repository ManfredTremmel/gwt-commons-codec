...
public class Nysiis implements StringEncoder {
    ...
    private static final String PAT_MAC    = "^MAC";
    private static final String PAT_KN     = "^KN";
    private static final String PAT_K      = "^K";
    private static final String PAT_PH_PF  = "^(PH|PF)";
    private static final String PAT_SCH    = "^SCH";
    private static final String PAT_EE_IE  = "(EE|IE)$";
    private static final String PAT_DT_ETC = "(DT|RT|RD|NT|ND)$";
    ...
    public String nysiis(String str) {
        ...
        str = str.replaceFirst(PAT_MAC, "MCC");
        str = str.replaceFirst(PAT_KN, "NN");
        str = str.replaceFirst(PAT_K, "C");
        str = str.replaceFirst(PAT_PH_PF, "FF");
        str = str.replaceFirst(PAT_SCH, "SSS");

        // Translate last characters of name:
        // EE -> Y, IE -> Y, DT | RT | RD | NT | ND -> D
        str = str.replaceFirst(PAT_EE_IE, "Y");
        str = str.replaceFirst(PAT_DT_ETC, "D");
